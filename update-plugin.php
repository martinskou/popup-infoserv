...
function github_plugin_updater_test_init() {
	...
	if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
        $config = array(
            ...
            'raw_url' => 'https://raw.githubusercontent.com/martinskou/popup-infoserv/master/init.php?token=46eecc40c2f76fb6b1563eea295ef63837fb3245', // the GitHub raw url of your GitHub repo
            ...
            'access_token' => '46eecc40c2f76fb6b1563eea295ef63837fb3245', // Access private repositories by authorizing under Appearance > GitHub Updates when this example plugin is installed
        );
